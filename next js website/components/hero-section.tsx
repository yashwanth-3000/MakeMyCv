                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    ...
                                    <p
                                        ...
                                        Professional, ATS-friendly resume templates powered by AI. Stand out from the crowd with a stunning CV that gets you hired.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <Link href="/create-cv">
                                                <span className="text-nowrap">Create Your CV</span>
                                            </Link>
                                        </Button>
                                    </div>
                                    <Button
